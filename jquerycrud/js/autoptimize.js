...
function loadWPGridHtml5LightBox(jsFolder) {
    (function ($) {
        $.fn.mplugingridlightbox = function (options) {
            var inst = this;
            inst.options = $.extend(
                {
            ...
            if (typeof wowgridgallerylightbox_options != "undefined" && wowgridgallerylightbox_options) $.extend(inst.options, wowgridgallerylightbox_options);
            if ($("div.wowgridgallerylightbox_options").length)
                $.each($("div.wowgridgallerylightbox_options").data(), function (key, value) {
            ...
            inst.disableKeyOutsideOfLightbox = function (event) {
                if ($(event.target).closest("#gridgallery-html5-lightbox").length <= 0) {
            ...
            inst.createMarkup = function () {
                ...
                inst.$lightbox = $(
                    "<div id='gridgallery-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" +
                ...
                else inst.$close.append("<img alt='' src='img/lightbox-close.png'>");
                ...
                if (inst.options.stamp)
                    inst.$watermark.html(
                        "<a href='" +
                            ...
                            "' style='text-decoration:none;' title='WordPress Gallery'><div style='display:block;width:180px;height:20px;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;'><div style='line-height:20px;'>" +
            ...
            inst.showNavigation = function () {
                ...
                $("body").append(
                    "<div id='gridgallery-html5-lightbox-nav' class='html5-nav' style='display:block;position:" +
                        posType +
                        ";" +
                        posCss +
                        "width:100%;height:" +
            ...
            inst.embedHTML5Video = function ($container, src, autoplay, loopvideo, mutevideo, playsinline) {
                ...
                if (!inst.options.nativehtml5controls && !inst.options.videohidecontrols) {
                    ...
                    $("video", $container).wpGridLightboxHTML5VideoControls(
            ...
            inst.each(function () {
                ...
                if (typeof wowgridgallerylightbox_options != "undefined" && wowgridgallerylightbox_options) {
                    if ("autoopen" in wowgridgallerylightbox_options) autoopen = wowgridgallerylightbox_options.autoopen;
                    if ("autoopendelay" in wowgridgallerylightbox_options) autoopendelay = wowgridgallerylightbox_options.autoopendelay;
                    if ("autoopenonce" in wowgridgallerylightbox_options) autoopenonce = wowgridgallerylightbox_options.autoopenonce;
                    if ("autoopenonceexpire" in wowgridgallerylightbox_options) autoopenonceexpire = wowgridgallerylightbox_options.autoopenonceexpire;
                }
...
(function ($) {
    $.fn.mplugingridgallery = function (options) {
        var WPGridGallery = function (container, options, id) {
            ...
            for (var i = 0; i < image_list.length; i++)
                if (this.options[image_list[i]])
                    if (this.options[image_list[i]].substring(0, 7).toLowerCase() != "http://" && this.options[image_list[i]].substring(0, 8).toLowerCase() != "https://" && this.options[image_list[i]].substring(0, 1).toLowerCase() != "/")
        ...
        WPGridGallery.prototype = {
            resizeImgObj: function ($img) {
                ...
                if (inst.options.textinsidespace) $img.css({ width: "100%", height: "auto", "max-width": "none" });
                else {
                    var w0 = $img.width();
                    var h0 = $img.height();
                    var cellWidth = inst.options.width;
                    var cellHeight = inst.options.height;
                    var $cell = $img.closest(".mplugin-gridgallery-item-container");
                    ...
                    if (w0 > 0 && h0 > 0 && ((inst.options.scalemode == "fill" && w0 / h0 > cellWidth / cellHeight) || (inst.options.scalemode == "fit" && w0 / h0 < cellWidth / cellHeight))) {
                        $img.css({ position: "relative", width: "auto", height: "100%", "max-width": "none", "max-height": "none", "margin-top": "0px" });
                        if (inst.options.centerimage && inst.options.scalemode == "fill")
                            if ($img.width() > 0)
                                setTimeout(function () {
                                    var ml = ($img.closest(".mplugin-gridgallery-item-container").width() - $img.width()) / 2;
                                    $img.css({ "margin-left": ml + "px" });
                                }, inst.options.imageposdelay);
                            else $img.css({ "margin-left": "0px" });
                    } else {
                        $img.css({ position: "relative", width: "100%", height: "auto", "max-width": "none", "max-height": "none", "margin-left": "0px" });
                        if (inst.options.centerimage)
                            if ($img.height() > 0)
                                setTimeout(function () {
                                    var mt = ($img.closest(".mplugin-gridgallery-item-container").height() - $img.height()) / 2;
                                    $img.css({ "margin-top": mt + "px" });
                                }, inst.options.imageposdelay);
                            else $img.css({ "margin-top": "0px" });
                    }
                }
            },
            initImgSizeOnLoad: function () {
                var inst = this;
                $(".mplugin-gridgallery-item-img", this.container)
                    .on("load", function () {
                ...
                $(".mplugin-gridgallery-item-video", this.container).each(function () {
                    if (inst.options.masonrymode || inst.options.justifymode)
            ...
            recalcJustifyPosition: function (img) {
                ...
                var item = img.closest(".mplugin-gridgallery-item");
            ...
            calcJustifyPosition: function () {
                ...
                var rowwidth = 0;
                var rowtop = 0;
                $(".mplugin-gridgallery-item", this.container).each(function (index) {
                    var is_last = $(this).next(".mplugin-gridgallery-item").length <= 0;
                    if ($(this).css("display") != "block" && !is_last) return;
                    var w0 = inst.item_width;
                    var h0 = inst.item_height;
                    if ($(".mplugin-gridgallery-item-img", this).length > 0 && $(".mplugin-gridgallery-item-img", this).data("naturalwidth") && $(".mplugin-gridgallery-item-img", this).data("naturalheight")) {
                        w0 = $(".mplugin-gridgallery-item-img", this).data("naturalwidth");
                        h0 = $(".mplugin-gridgallery-item-img", this).data("naturalheight");
                    }
                    ...
                    if ((is_last && (rowcount > 0 || $(this).css("display") == "block")) || rowwidth + w1 + rowcount * inst.options.gap > inst.total_width) {
                        ...
                        if (is_last || Math.abs(rowwidth + w1 + rowcount * inst.options.gap - inst.total_width) <= Math.abs(rowwidth + (rowcount > 0 ? rowcount : 0) * inst.options.gap - inst.total_width)) {
                            rowstart = index + 1;
                            rowwidth = 0;
                            rowcount = 0;
                        ...
                        var curr_rowitem = $(".mplugin-gridgallery-item-" + curr_rowstart, inst.container);
                        var curr_index = 0;
                        var curr_x = 0;
                        var curr_rowlimitedheight = curr_rowheight;
                        var limit_height = false;
                        if (is_last)
                        ...
                        while (curr_rowitem.length > 0 && curr_index < curr_rowcount) {
                            if (curr_rowitem.css("display") == "block") {
                                var curr_naturalwidth = inst.item_width;
                                var curr_naturalheight = inst.item_height;
                                if (
                                    $(".mplugin-gridgallery-item-img", curr_rowitem).length > 0 &&
                                    $(".mplugin-gridgallery-item-img", curr_rowitem).data("naturalwidth") &&
                                    $(".mplugin-gridgallery-item-img", curr_rowitem).data("naturalheight")
                                ) {
                                    curr_naturalwidth = $(".mplugin-gridgallery-item-img", curr_rowitem).data("naturalwidth");
                                    curr_naturalheight = $(".mplugin-gridgallery-item-img", curr_rowitem).data("naturalheight");
                                }
                                var curr_itemwidth = (curr_rowheight * curr_naturalwidth) / curr_naturalheight;
                                curr_rowitem.css({ left: curr_x + "px", top: rowtop + "px", width: curr_itemwidth + "px", height: curr_rowheight + "px" });
                                var curr_rowimg = $(".mplugin-gridgallery-item-img", curr_rowitem);
                                curr_rowimg.css({ "margin-top": 0 });
                                if (is_last && limit_height) {
                                    curr_rowitem.css({ height: curr_rowlimitedheight + "px" });
                                    curr_rowimg.css({ "margin-top": "-" + String((curr_rowheight - curr_rowlimitedheight) / 2) + "px" });
                                }
                                curr_x += curr_itemwidth + inst.options.gap;
                                curr_index++;
                            }
                            curr_rowitem = curr_rowitem.next(".mplugin-gridgallery-item");
                        }
                        row++;
            ...
            calcMasonryPosition: function () {
                ...
                $(".mplugin-gridgallery-item", this.container).each(function () {
                    if ($(this).css("display") == "block") {
                        if (inst.options.masonrysmartalign) {
                            cur_col = 0;
                            cur_posy = pos_y[0];
                            for (var i = 1; i < inst.column_num; i++)
                                if (pos_y[i] < cur_posy) {
                                    cur_col = i;
                                    cur_posy = pos_y[i];
                                }
                        ...
                        var img = $(".mplugin-gridgallery-item-video", this).length > 0 ? $(".mplugin-gridgallery-item-video", this) : $(".mplugin-gridgallery-item-img", this);
            ...
            calcPosition: function () {
                if (this.options.masonrymode || this.options.justifymode) {
                    $(".mplugin-gridgallery-item-container", this.container).css({ width: "100%", height: "100%" });
                ...
                if (this.options.categoryshow && this.options.categoryposition && $.inArray(this.options.categoryposition, ["lefttop", "righttop"]) > -1 && screenWidth > this.options.verticalcategorysmallscreenwidth)
                    $(".mplugin-gridgallery-list", this.container).css({ width: "auto" });
                else $(".mplugin-gridgallery-list", this.container).css({ width: this.total_width + "px" });
                this.list_height = list_height;
                $(".mplugin-gridgallery-list", this.container).css({ height: list_height + "px" });
                if (this.options.categoryshow && this.options.categoryposition && $.inArray(this.options.categoryposition, ["topleft", "topcenter", "topright", "bottomleft", "bottomcenter", "bottomright"]) > -1)
                    $(".mplugin-gridgallery-tags", this.container).css({ width: this.total_width + "px" });
                this.applyPosition();
            },
            applyPosition: function () {
                ...
                $(".mplugin-gridgallery-item", this.container).each(function (index) {
                    ...
                    $(this).css({ left: inst.elemArray[posIndex].x, top: inst.elemArray[posIndex].y, width: inst.elemArray[posIndex].w, height: inst.elemArray[posIndex].h });
                    $(".mplugin-gridgallery-item-container", this).css({
                    ...
                    if (inst.options.circularimage) $(".mplugin-gridgallery-item-container, .mplugin-gridgallery-item-img", this).css({ "-webkit-border-radius": "50%", "-moz-border-radius": "50%", "border-radius": "50%" });
                    posIndex++;
                });
            },
            applyWidth: function () {
                var inst = this;
                $(".mplugin-gridgallery-item", this.container).each(function () {
                    inst.resizeImgObj($(".mplugin-gridgallery-item-img", this));
                });
            },
            applyLazy: function (item) {
                if (this.options.supportlazytags) {
                    ...
                    for (var i = 0; i < lazytags.length; i++) {
                        var src = $(".mplugin-gridgallery-item-img", item).attr("src");
                        var lazysrc = $(".mplugin-gridgallery-item-img", item).data(lazytags[i]);
                        if (lazysrc && lazysrc.length > 0 && lazysrc != src) {
                            $(".mplugin-gridgallery-item-img", item).attr("src", lazysrc);
                            break;
                        }
                    }
                }
            ...
            showCategory: function (cat) {
                var instance = this;
                var totalitems = $(".mplugin-gridgallery-item", this.container).length;
                if (this.options.lightboxshowallcategories)
                    $(".mplugin-gridgallery-item", this.container)
                        .find("a")
                        .data("showall", cat && cat.length > 0 && $.inArray("all", cat) > -1);
                var start = -1;
                var end = -1;
                    ...
                    if ($.inArray("all", cat) > -1) {
                        $(".mplugin-gridgallery-item", this.container).each(function (index) {
                            if (end > 0 && (index >= end || index < start)) {
                                ...
                                $(this).removeClass("mplugin-gridgallery-item-visible");
                            } else {
                                $(this).css({ display: "block" });
                                $(this).addClass("mplugin-gridgallery-item-visible");
                                instance.applyLazy(this);
                            }
                            if (!instance.options.lightboxnogroup)
                                $(this)
                                    .find("a.wpgridlightbox")
                                    .data("group", "wpgridgallery-" + instance.id);
                        });
                        if (this.options.lazyloadmode == "loadmore" && end >= $(".mplugin-gridgallery-item", this.container).length) $(".mplugin-gridgallery-loadmore", this.container).css({ display: "none" });
                    } else {
                        var count = 0;
                        $(".mplugin-gridgallery-item", this.container).each(function (index) {
                            ...
                            if (!instance.options.lightboxcategorygroup && !instance.options.lightboxnogroup)
                                $(this)
                                    .find("a.wpgridlightbox")
                                    .data("group", "wpgridgallery-" + instance.id);
                            $(this).css({ display: style });
                            if (style == "block") $(this).addClass("mplugin-gridgallery-item-visible");
                            else $(this).removeClass("mplugin-gridgallery-item-visible");
                            if (style == "block") instance.applyLazy(this);
                        });
                        if (this.options.lazyloadmode == "loadmore" && end >= count) $(".mplugin-gridgallery-loadmore", this.container).css({ display: "none" });
                    }
                    if (this.options.categoryregulardropdown) $(".mplugin-gridgallery-tag-dropdown", this.container).val(cat);
                    else {
                        $(".mplugin-gridgallery-tag", this.container).removeClass("mplugin-gridgallery-tag-selected");
                        $(".mplugin-gridgallery-tag", this.container).each(function () {
                            if ($.inArray(String($(this).data("slug")), cat) > -1) $(this).addClass("mplugin-gridgallery-tag-selected");
                        });
                    }
                } else if (instance.options.categorymulticat && instance.options.categorymulticatand && instance.options.categorymulticatandnone)
                    $(".mplugin-gridgallery-item", this.container).each(function (index) {
                        $(this).find("a.wpgridlightbox").removeData("group");
                        $(this).css({ display: "none" });
                        $(this).removeClass("mplugin-gridgallery-item-visible");
            ...
            initDropdownCategories: function () {
                var instance = this;
                $(".mplugin-gridgallery-tag-dropdown", this.container).change(function () {
            ...
            initButtonCategories: function () {
                var instance = this;
                $(".mplugin-gridgallery-tag", this.container).click(function () {
                    if (instance.options.categorymulticat) {
                        if ($(this).hasClass("mplugin-gridgallery-tag-selected")) {
                            if (instance.options.categoryatleastone && $(".mplugin-gridgallery-tag-selected", instance.container).length <= 1) return;
                            $(this).removeClass("mplugin-gridgallery-tag-selected");
                        } else {
                            if ($(this).data("slug") == "all") $(".mplugin-gridgallery-tag", instance.container).removeClass("mplugin-gridgallery-tag-selected");
                            else $(".mplugin-gridgallery-tag[data-slug='all']", instance.container).removeClass("mplugin-gridgallery-tag-selected");
                            $(this).addClass("mplugin-gridgallery-tag-selected");
                        }
                        var cat = new Array();
                        $(".mplugin-gridgallery-tag", instance.container).each(function () {
                            if ($(this).hasClass("mplugin-gridgallery-tag-selected")) cat.push(String($(this).data("slug")));
                        });
                        instance.categories = cat;
                    } else {
                        if ($(this).hasClass("mplugin-gridgallery-tag-selected")) return;
                        $(".mplugin-gridgallery-tag", this.container).removeClass("mplugin-gridgallery-tag-selected");
                        $(this).addClass("mplugin-gridgallery-tag-selected");
            ...
            initCategoryDropmenu: function () {
                $(".mplugin-gridgallery-selectcategory", this.container).on("click", function () {
                    var menu = $(this).closest(".mplugin-gridgallery-tags").find(".mplugin-gridgallery-menu");
                    if (menu.is(":visible")) menu.hide();
                    else menu.show();
                });
            },
            init: function () {
                $(window).trigger("initstarted.mplugingrid", [this.id]);
                this.container.css({ display: "block" });
                this.elemArray = new Array();
                var inst = this;
                $(".mplugin-gridgallery-item", this.container).each(function (index) {
                    $(this).addClass("mplugin-gridgallery-item-" + index);
                    ...
                    if ($("a", this).length > 0) {
                        var itemtext = null;
                        if (inst.options.usetemplatefortextoverlay && $(".mplugin-gridgallery-item-text", this).length > 0) itemtext = $(".mplugin-gridgallery-item-text", this);
                            ...
                            if (inst.options.showtexttitle) {
                                ...
                                if (title && title.length > 0) text += '<div class="mplugin-gridgallery-item-title">' + title + "</div>";
                            }
                            if (inst.options.showtextdescription) {
                                var description = $("a", this).data("description");
                                if (description && description.length > 0) text += '<div class="mplugin-gridgallery-item-description">' + description + "</div>";
                            }
                            if (text.length > 0 || (inst.options.showtextbutton && $(".mplugin-gridgallery-item-button", this).length > 0)) {
                                text = '<div class="mplugin-gridgallery-item-wrapper">' + text + "</div>";
                                itemtext = $('<div class="mplugin-gridgallery-item-text">' + text + "</div>");
                                $(this).append(itemtext);
                                if (inst.options.showtextbutton && $(".mplugin-gridgallery-item-button", this).length > 0)
                                    $(".mplugin-gridgallery-item-button", this).css({ display: "block" }).appendTo($(".mplugin-gridgallery-item-wrapper", this));
                            }
                        }
                        if (itemtext) {
                            if (inst.options.showtitle && (inst.options.titlemode == "always" || inst.options.titleeffect == "flipy")) itemtext.css({ display: "block" });
                            else itemtext.css({ display: "none" });
                            if (inst.options.titlemode != "always" && inst.options.titleeffect == "flipy") {
                                $(".mplugin-gridgallery-item-container, .mplugin-gridgallery-item-caption", this).addClass("mplugingridgallery-flipy-in");
                                itemtext.addClass("mplugingridgallery-flipy-out");
                            }
                            if (inst.options.overlaylink) {
                                var href = $("a", this).attr("href");
                                if (href.length > 0 && href != "#") {
                                    $(".mplugin-gridgallery-item-text", this).css({ cursor: "pointer" });
                                    $(".mplugin-gridgallery-item-text", this).click(function () {
                                        if ($(".mplugin-gridgallery-item-img", $(this).parent()).length > 0) $(".mplugin-gridgallery-item-img", $(this).parent()).trigger("click");
                                        else if ($(".mplugin-gridgallery-item-video", $(this).parent()).length > 0) $(".mplugin-gridgallery-item-video", $(this).parent()).trigger("click");
                                    });
                                }
                            }
                        }
                        var href = $("a", this).attr("href");
                        if (href && ($("a", this).data("isvideo") || inst.isVideo(href)) && inst.options.addvideoplaybutton)
                            $(".mplugin-gridgallery-item-container a", this).append(
                                '<div class="mplugin-gridgallery-elem-videobutton" style="position:absolute;top:0px;left:0px;width:100%;height:100%;background:url(' + inst.options.videoplaybutton + ') no-repeat center center"></div>'
                            );
                    }
                    if (inst.options.enabletabindex) {
                        $(".mplugin-gridgallery-item-img, .mplugin-gridgallery-item-video", inst.container).each(function () {
                            if ($(this).parent().is("a")) {
                                $(this)
                                    .parent()
                                    .attr("tabindex", "0")
                                    .focus(function () {
                                        $(this).closest(".mplugin-gridgallery-item").trigger("mouseenter");
                                    })
                                    .focusout(function () {
                                        $(this).closest(".mplugin-gridgallery-item").trigger("mouseleave");
                                    });
                        ...
                        if (inst.options.categoryregulardropdown) $(".mplugin-gridgallery-tag-dropdown", inst.container).attr("tabindex", "0");
                        else
                            $(".mplugin-gridgallery-tag", inst.container)
                                .attr("tabindex", "0")
                                .keyup(function (e) {
                                    if (e.keyCode == 13) $(this).trigger("click");
                                });
                    ...
                    if (index % 4 == 1 && inst.options.stamp)
                        $(this).append(
                            '<a href="' +
                                inst.options.marklink +
                                '" target="_blank"><div style="display:block !important;visibility:visible !important;position:absolute;top:2px;left:2px;padding:2px 4px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#eee;color:#333;font:12px Arial,sans-serif;">' +
                                inst.options.mark +
                                "</div></a>"
                        );
                });
                ...
                this.initCategories();
                $(".mplugin-gridgallery-item-container", this.container).css({ display: "block", position: "relative", overflow: "hidden", "text-align": "center", margin: this.options.margin / 2 });
                ...
                if (!("ontouchstart" in window) || !this.options.nohoverontouchscreen) {
                    $(".mplugin-gridgallery-item", this.container).data("highlighted", 0);
                    if ("ontouchstart" in window && this.options.useclickontouchscreen)
                        $(".mplugin-gridgallery-item", this.container).on("click", function () {
                        ...
                        $(".mplugin-gridgallery-item", this.container).hover(
                            function () {
                                inst.onItemHighlight(this);
                            },
                            function () {
                ...
                this.initFirstLoad();
                $(window).trigger("initfinished.mplugingrid", [this.id]);
                if (this.options.triggerresizeafterinit)
                    setTimeout(function () {
            ...
            initHoverCSS: function () {
                if (this.options.hoverzoomin) {
                    var css = "";
                    var galleyrID = this.options.ispreview ? "#mplugin-gridgallery-preview" : "#mplugingridgallery-" + this.id;
                    if (this.options.hoverzoominimageonly) {
                        css +=
                            galleyrID +
                            " .mplugin-gridgallery-item .mplugin-gridgallery-item-img { transition: transform " +
                            this.options.hoverzoominimageduration +
                            "ms ease-in-out; transform-origin:" +
                            (this.options.hoverzoominimagecenter ? "center" : "top left") +
                            ";}";
                        css += galleyrID + " .mplugin-gridgallery-item:hover .mplugin-gridgallery-item-img { transform: scale(" + this.options.hoverzoominimagescale + ");}";
                    } else {
                        css += galleyrID + " .mplugin-gridgallery-item { transition: transform " + this.options.hoverzoominduration + "ms ease-in-out; }";
                        css += galleyrID + " .mplugin-gridgallery-item:hover { transform: scale(" + String(1 + this.options.hoverzoominvalue / this.options.width) + "); z-index: 1; }";
                    }
                    $("head").append('<style data-creator="mplugingridgallerycreator" type="text/css">' + css + "</style>");
                }
            },
            onItemHighlight: function (item) {
                var inst = this;
                if (inst.options.hoverfade) $(".mplugin-gridgallery-item-img", item).animate({ opacity: inst.options.hoverfadeopacity }, { queue: false, duration: inst.options.hoverfadeduration });
                inst.showTitle(item);
            },
            onItemDehighlight: function (item) {
                var inst = this;
                if (inst.options.hoverfade) $(".mplugin-gridgallery-item-img", item).animate({ opacity: 1 }, { queue: false, duration: inst.options.hoverfadeduration });
                inst.hideTitle(item);
            },
            initFirstLoad: function () {
                var params = this.getParams();
                var total = $(".mplugin-gridgallery-item", this.container).length;
                if ("wpgalleryitemid" in params && params["wpgalleryitemid"] >= 0 && params["wpgalleryitemid"] < total) {
                    var item = $(".mplugin-gridgallery-item", this.container).eq(params["wpgalleryitemid"]);
                    if (item.find(".mplugin-gridgallery-item-img").length > 0) item.find(".mplugin-gridgallery-item-img").click();
                    else if (item.find(".mplugin-gridgallery-item-video").length > 0) item.find(".mplugin-gridgallery-item-video").click();
                }
            },
            initLazyLoad: function (cat) {
                this.pageloaded = 1;
                $(".mplugin-gridgallery-loadmore", this.container).remove();
                $(".mplugin-gridgallery-pagination", this.container).remove();
                var totalitems = $(".mplugin-gridgallery-item", this.container).length;
                ...
                if (this.options.itemsperpage < totalitems)
                    if (this.options.lazyloadmode == "loadmore") {
                        this.container.append('<div class="mplugin-gridgallery-loadmore"><button type="button" class="mplugin-gridgallery-loadmore-btn">' + this.options.loadmorecaption + "</button></div>");
                        var instance = this;
                        $(".mplugin-gridgallery-loadmore-btn", this.container).click(function () {
                            instance.pageloaded++;
                            instance.showCategory(instance.categories);
                        });
                    } else if (this.options.lazyloadmode == "pagination") {
                        var page_count = Math.ceil(totalitems / this.options.itemsperpage);
                        var page_buttons = '<div class="mplugin-gridgallery-pagination">';
                        for (var i = 1; i <= page_count; i++)
                            page_buttons += '<button type="button" class="mplugin-gridgallery-pagination-btn' + (i == 1 ? " mplugin-gridgallery-pagination-btn-selected" : "") + '" data-pageindex="' + i + '">' + i + "</button>";
                        page_buttons += "</div>";
                        if (this.options.paginationpos == "top") this.container.prepend(page_buttons);
                        else this.container.append(page_buttons);
                        var instance = this;
                        $(".mplugin-gridgallery-pagination-btn", this.container).click(function () {
                            $(".mplugin-gridgallery-pagination-btn", instance.container).removeClass("mplugin-gridgallery-pagination-btn-selected");
                            $(this).addClass("mplugin-gridgallery-pagination-btn-selected");
            ...
            showTitle: function (parent) {
                ...
                var text_div = $(".mplugin-gridgallery-item-text", parent);
                var item_div = $(".mplugin-gridgallery-item-container", parent);
                var caption_div = $(".mplugin-gridgallery-item-caption", parent);
                if (text_div.length > 0)
                    if (this.options.titleeffect == "flipy") {
                        caption_div.removeClass("mplugingridgallery-flipy-in").addClass("mplugingridgallery-flipy-out");
                        item_div.removeClass("mplugingridgallery-flipy-in").addClass("mplugingridgallery-flipy-out");
                        text_div.removeClass("mplugingridgallery-flipy-out").addClass("mplugingridgallery-flipy-in");
            ...
            hideTitle: function (parent) {
                ...
                if (text_div.length > 0)
                    if (this.options.titleeffect == "flipy") {
                        caption_div.removeClass("mplugingridgallery-flipy-out").addClass("mplugingridgallery-flipy-in");
                        item_div.removeClass("mplugingridgallery-flipy-out").addClass("mplugingridgallery-flipy-in");
                        text_div.removeClass("mplugingridgallery-flipy-in").addClass("mplugingridgallery-flipy-out");
            ...
            isVideo: function (href) {
                ...
                if (
                    href.match(/\.(mp4|m4v|ogv|ogg|webm|flv)(.*)?$/i) ||
                    href.match(/\:\/\/.*(youtube\.com)/i) ||
                    href.match(/\:\/\/.*(youtu\.be)/i) ||
                    href.match(/\:\/\/.*(vimeo\.com)/i) ||
            ...
            calcAllWidth: function (total_width) {
                ...
                if (this.options.categoryshow && this.options.categoryposition && $.inArray(this.options.categoryposition, ["lefttop", "righttop"]) > -1)
                    if ($(".mplugin-gridgallery-tags-lefttop").length > 0) total_width += $(".mplugin-gridgallery-tags-lefttop").width();
                    else if ($(".mplugin-gridgallery-tags-righttop").length > 0) total_width += $(".mplugin-gridgallery-tags-righttop").width();
                return total_width;
            },
            calcTotalWidth: function (all_width) {
                ...
                if (this.options.categoryshow && this.options.categoryposition && $.inArray(this.options.categoryposition, ["lefttop", "righttop"]) > -1)
                    if ($(".mplugin-gridgallery-tags-lefttop").length > 0) all_width -= $(".mplugin-gridgallery-tags-lefttop").width();
                    else if ($(".mplugin-gridgallery-tags-righttop").length > 0) all_width -= $(".mplugin-gridgallery-tags-righttop").width();
                return all_width;
            },
            positionGallery: function (init) {
                ...
                if (this.options.mediumscreen && screenWidth <= this.options.mediumscreensize) {
                ...
                if (this.options.smallscreen && screenWidth <= this.options.smallscreensize) {
                    if (this.options.smallgridsize) {
                        this.options.width = this.options.smallwidth;
                ...
                if (this.options.firstimage) {
                    $(".mplugin-gridgallery-list", this.container).css({ width: this.item_width + "px", height: this.container_height + "px" });
                    $(".mplugin-gridgallery-item-container", this.container).css({
                    ...
                    if (screenWidth > this.options.verticalcategorysmallscreenwidth) {
                        $(".mplugin-gridgallery-tags-lefttop").removeClass("mplugin-gridgallery-tags-lefttop-smallscreen");
                        $(".mplugin-gridgallery-tags-righttop").removeClass("mplugin-gridgallery-tags-righttop-smallscreen");
                        $(".mplugin-gridgallery-list", this.container).css({ overflow: "hidden" });
                    } else {
                        $(".mplugin-gridgallery-tags-lefttop").addClass("mplugin-gridgallery-tags-lefttop-smallscreen");
                        $(".mplugin-gridgallery-tags-righttop").addClass("mplugin-gridgallery-tags-righttop-smallscreen");
                        $(".mplugin-gridgallery-list", this.container).css({ overflow: "visible" });
                        if (this.options.categoryposition == "righttop") $(".mplugin-gridgallery-list", this.container).css({ float: "none" });
                    }
                }
                if (init) {
                    var cat = ["all"];
        ...
        this.each(function () {
            ...
            var initGridGallery = function (inst) {
                ...
                if ($("#wpgridlightbox_advanced_options").length)
                    $.each($("#wpgridlightbox_advanced_options").data(), function (key, value) {
                        lightboxOptions[key.toLowerCase()] = value;
                    });
                if ($("#wpgridlightbox_advanced_options_" + inst.options.gridgalleryid).length)
                    $.each($("#wpgridlightbox_advanced_options_" + inst.options.gridgalleryid).data(), function (key, value) {
                        lightboxOptions[key.toLowerCase()] = value;
                    });
                if ($("#wowgridgallerylightbox_options_" + inst.options.gridgalleryid).length)
                    $.each($("#wowgridgallerylightbox_options_" + inst.options.gridgalleryid).data(), function (key, value) {
                        lightboxOptions[key.toLowerCase()] = value;
                    });
                wpGridLightboxObject = $(".wpgridlightbox-" + inst.options.gridgalleryid).mplugingridlightbox(lightboxOptions);
                ...
                if ($(".wpgridinlinehtml5video").length) {
                    var options = $.extend({}, inst.options, { videoplaysinline: 1 });
                ...
                if ($(".wpgridloadhtml5video").length)
                    $(".wpgridloadhtml5video").each(function () {
                ...
                if ($(".wpgridautoplayhtml5video").length)
                    $(".wpgridautoplayhtml5video").each(function () {
                        var options = $.extend({}, inst.options, { videoplaysinline: 1, videomuted: 1, videoloop: $(this).data("loop"), videohidecontrols: $(this).data("hidecontrols"), videoposter: $(this).data("poster") });
                        $(this).wpgridPlayHTML5Video(object, inst.options.gridgalleryid, options, true);
                    });
                if ($(".wpgridplayhtml5videoonclick").length)
                    $(".wpgridplayhtml5videoonclick").each(function () {
                        var options = $.extend({}, inst.options, {
                            videoplayonclick: 1,
                            videoplaysinline: 1,
                            videomuted: $(this).data("muted"),
                ...
                if ($(".wpgridplayhtml5videoonhover").length)
                    $(".wpgridplayhtml5videoonhover").each(function () {
                        var options = $.extend({}, inst.options, {
                            videoplayonhover: 1,
                            videoplaysinline: 1,
                            videomuted: 1,
            ...
            var initRemote = function (inst) {
                ...
                $.getJSON(inst.options.remote, function (data) {
                    for (var i = 0; i < data.length; i++) {
                        remote_items += '<div class="mplugin-gridgallery-item"';
                        if (data[i].category) remote_items += ' data-category="' + data[i].category + '"';
                        remote_items += ' data-row="1" data-col="1"><div class="mplugin-gridgallery-item-container">';
                        if (data[i].link) {
                        ...
                        remote_items += '<img class="mplugin-gridgallery-item-img"';
                        if (data[i].alt) remote_items += ' alt="' + data[i].alt + '"';
                    ...
                    if ($(".mplugin-gridgallery-list", $(inst)).length > 0) $(".mplugin-gridgallery-list", $(inst)).append(remote_items);
                    else {
                        remote_items = '<div class="mplugin-gridgallery-list" style="display:block;position:relative;max-width:100%;margin:0 auto;">' + remote_items + '</div><div style="clear:both;"></div>';
...
jQuery(document).ready(function () {
    jQuery(".mplugin-gridgallery-engine").css({ display: "none" });
    if (jQuery.fn.mplugingridgallery) jQuery(".mplugingridgallery").mplugingridgallery();
});
